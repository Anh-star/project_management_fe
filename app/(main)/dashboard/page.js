...
function DashboardCard({ title, value, isWarning = false }) {
  return (
    ...
    <div className={`${styles.card} group`}>
      {/* Background Icon mờ */}
      <div
        className={`${styles.cardIconBg} ${isWarning ? styles.iconBgWarning : styles.iconBgDefault}`}
      />
      ...
      <div className={styles.cardContent}>
        ...
        <div className={styles.cardValueContainer}>
          <span
            className={`${styles.cardValue} ${isWarning ? styles.valueWarning : styles.valueDefault}`}
          >
            {value || 0}
          </span>
        </div>
